...
class DWposeDetector:
    def __init__(self, model_det: str, model_pose: str, device: str = "cuda"):
        # v8.20: explicit onnx paths (the worker stages them itself); no download at import time.
        self.pose_estimation = Wholebody(device=device, model_det=model_det, model_pose=model_pose)
