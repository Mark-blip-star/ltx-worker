...
def _attention_type(config: dict) -> AttentionFunction:
    requested_type = os.environ.get("LTX_ATTENTION_TYPE", config.get("attention_type", "default"))
    return AttentionFunction(requested_type)
